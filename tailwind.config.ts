  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'glow-gradient': 
          'linear-gradient(135deg, rgba(0, 245, 255, 0.1) 0%, rgba(191, 0, 255, 0.1) 50%, rgba(255, 0, 255, 0.1) 100%)',
      },
      backgroundSize: {
        'grid': '50px 50px',
      },
      ...
      keyframes: {
        ...
        glowPulse: {
          ...
          '50%': { boxShadow: '0 0 40px rgba(0, 245, 255, 0.6), 0 0 60px rgba(191, 0, 255, 0.3)' },
        },
      },
      boxShadow: {
        ...
        'card-glow': '0 0 0 1px rgba(0, 245, 255, 0.1), 0 4px 24px rgba(0, 0, 0, 0.4)',
      },
      backdropBlur: {
        xs: '2px',
      },
